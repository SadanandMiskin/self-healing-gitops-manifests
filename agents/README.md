...
The agent continuously observes Prometheus alerts, reads Kubernetes logs, asks Mistral AI or the mock LLM for diagnosis, checks a narrow safety policy, modifies the manifests Git repository, and opens a pull request.
...
- `diagnoser.py`: uses Mistral AI or mock LLM to diagnose the logs
...
For one-cycle debugging without Mistral:
